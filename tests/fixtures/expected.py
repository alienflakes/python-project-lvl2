...
result_parsing_flat = [
    {'name': 'follow', 'value': False,
     'children': None, 'status': 'removed'},
    {'name': 'host', 'value': 'hexlet.io',
     'children': None, 'status': 'same'},
    {'name': 'proxy', 'value': '123.234.53.22',
     'children': None, 'status': 'removed'},
    {'name': 'timeout', 'value': 50,
     'children': None, 'status': 'changed_from_file1'},
    {'name': 'timeout', 'value': 20,
     'children': None, 'status': 'changed_from_file2'},
    {'name': 'verbose', 'value': True,
     'children': None, 'status': 'added'},
]
